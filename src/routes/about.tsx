  ...
  return (
    <>
      <section className="site-container grid gap-12 py-16 md:grid-cols-[0.7fr_1.3fr] md:py-24">
        <p className="eyebrow self-start">About the work</p>
        <div>
      ...
      <section className="site-container pb-20 md:pb-28">
        <div className="image-reveal aspect-[16/8] md:aspect-[16/7]">
      ...
      <section className="border-y bg-paper py-20 md:py-28">
        <div className="site-container grid gap-12 md:grid-cols-[0.65fr_1.35fr]">
          <div><p className="eyebrow">Track record</p></div>
          <div className="divide-y border-y">
            {[
              ...
              <article key={number} className="grid gap-5 py-9 sm:grid-cols-[4rem_1fr]">
      ...
      <section className="site-container flex flex-col items-start justify-between gap-8 py-20 md:flex-row md:items-end md:py-28">
        <h2 className="display-heading max-w-3xl text-5xl sm:text-6xl">The right structure changes what a team can <span className="text-primary italic">believe.</span></h2>
        <Button asChild><Link to="/work">See the work <ArrowRight aria-hidden="true" /></Link></Button>
      </section>
    </>
  );
}
